...
public class UsersController : BaseApiController
{
    ...
    public UsersController(IUserRepository userRepository, IMapper mapper, IPhotoService photoService) //this context is scoped to the http req only
    {
    ...
    public async Task<ActionResult> SetMainPhoto (int photoId){
        ...
        //first of default returns null so make sure its not null
